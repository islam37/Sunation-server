...
header('location:.php');
	...
	if(isset($_POST['update']))
	{
		...
		$query=mysqli_query($con,"update users set billingAddress='$baddress',billingCity='$bcity',billingPincode='$bpincode' where id='".$_SESSION['id']."'");
		if($query)
		{
...
// code for Shipping address updation
	if(isset($_POST['shipupdate']))
	{
		...
		$query=mysqli_query($con,"update users set shippingAddress='$saddress',shippingCity='$scity',shippingPincode='$spincode' where id='".$_SESSION['id']."'");
		if($query)
		{
